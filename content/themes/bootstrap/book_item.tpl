[@breadcrumb]
<div class="module-item" style="margin-top: 30px;">
	  ...
	  <div class="row-item">
       ...
       <br>
			<ul class="item-info">
			   ...
			   <li>
				  <div><strong style="font-weight: 600;">Author:</strong></div>
				  <div style="margin-top:5px;">[@author]</div>
			   </li>
			  
			   <li>
				  <div><strong style="font-weight: 600;">Region:</strong></div>
				  <div style="margin-top:5px;">[@region]</div>
			   </li>
			    <li>
